...
import { Send, GraduationCap, Trash2, AlertCircle } from "lucide-react"
...
export function ChatInterface() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.status === 429) {
        ...
        setRateLimitWarning(`Rate limited. Please wait ${retryAfter} seconds before trying again.`)
  ...
  return (
    <div className="flex flex-col w-full h-screen max-w-4xl mx-auto p-4 md:p-6">
      <div className="flex items-center gap-3 mb-6 pb-4 border-b justify-between">
        ...
        <div className="flex-1 overflow-hidden relative">
          <div ref={viewportRef} className="h-full overflow-y-auto p-4 md:p-6">
            <div className="space-y-4">
              ...
              {rateLimitWarning && (
                <div className="p-4 bg-yellow-500/10 text-yellow-700 dark:text-yellow-400 rounded-lg flex gap-2">
